    ...
    <div>
      <div className='container '>
        ...
        <div className='keypad'>
          <button className='color' onClick={clear} id='clear'>Clear</button>
          <button className='color'  onClick={backspace} id='backspace'>C</button>
          ...
          <button className='color'  name='=' onClick={handleCalculate} id='result'>=</button>
